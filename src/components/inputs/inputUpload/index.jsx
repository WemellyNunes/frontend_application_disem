                  ...
                  {uploadedFiles.map((item, index) => (
                      <div key={index} className="flex justify-between items-center border border-gray-200 rounded-md p-1.5 mt-1">
                          <div className="flex flex-col">
                              <span className="text-xs md:text-sm font-light text-primary-light">{item.file.name}</span>
                          ...
                          <div className="flex">
                              <button onClick={() => handlePreviewFile(item.file)} className="text-blue-500 text-xs md:text-sm mr-2">Visualizar</button>
