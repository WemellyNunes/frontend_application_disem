import React, { useState, forwardRef } from "react"; // Certifique-se de incluir forwardRef aqui


const InputPrimary = forwardRef(({ label, placeholder, value, onChange }, ref) => {
  return (
    <div className="w-full flex flex-col mb-4">
      ...
      <input
        ...
        onChange={onChange} // Chama a função passada como prop
        ref={ref}
      />
    </div>
  );
